...
Przegląd zakresu i odpowiedzialności w poszczególnych rolach w mojej karierze — uzupełnienie [Przebiegu kariery zawodowej](historia-zawodowa-skrot.md) (daty i stanowiska) oraz [Rozwijanych Produktów](rozwijane-produkty.md) (co zostało zbudowane), bez powtarzania żadnego z nich.
...
### Release Train Engineer — wrz 2016 – wrz 2018
- RTE dla Agile Release Train liczącego do 9 zespołów (80+ osób, wliczając role wspierające).
- Agent Zmiany napędzający wdrażanie zwinności.
...
### Scrum Master — wrz 2016 – wrz 2018
Budowanie i wspieranie zwinnego środowiska pracy trzech zespołów (24 osoby).

### Embedded Project Software Engineer — gru 2015 – sie 2016
Rozwój firmware'u wbudowanego dla modułów komunikacyjnych ControlLogix (zobacz [Rozwijane Produkty](rozwijane-produkty.md)).


## Mentor Graphics

### Software Development Team Leader — paź 2014 – lis 2015
Kierowanie zespołem badawczo-rozwojowym budującym czwartą generację produktu SCADA opartego o IoT — Data Acquisition Unit (zobacz [Rozwijane Produkty](rozwijane-produkty.md)) — w tym budowa fizycznego sprzętu testowego.

### Scrum Master — paź 2014 – lis 2015
Budowanie i wspieranie zwinnego środowiska pracy dla jednego zespołu (10 osób).

### Software Development Engineer — lip 2005 – wrz 2014
Dostarczanie modułów Xpedition PCB (zobacz [Rozwijane Produkty](rozwijane-produkty.md)). Od 2010 roku praca w ramach frameworku Scrum oraz aktywny udział we wdrażaniu i budowaniu wiedzy zespołu na temat Scruma.


## Centrum Elektryfikacji i Automatyzacji Górnictwa „EMAG” - ośrodek badawczo rozwojowy

### Specjalista techniczny - programista — lis 2000 – lip 2005
Realizacja projektów z obszaru SCADA i telemetrii (zobacz [Rozwijane Produkty](rozwijane-produkty.md)).
