...
An overview of the scope and responsibilities behind each role in my career — complementing [Career Timeline](work-history-brief.md) (dates and titles) and [Developed Products](developed-products.md) (what was built), without repeating either.
...
### Release Train Engineer — Sep 2016 – Sep 2018
- RTE for an Agile Release Train of up to 9 teams (80+ people, including supporting roles).
- Change agent driving Agile adoption.
...
### Scrum Master — Sep 2016 – Sep 2018
Built and supported an agile working environment for three teams (24 people).

### Embedded Project Software Engineer — Dec 2015 – Aug 2016
Embedded firmware development for the ControlLogix communication modules (see [Developed Products](developed-products.md)).


## Mentor Graphics

### Software Development Team Leader — Oct 2014 – Nov 2015
Led the R&D team building a fourth-generation, IoT-based SCADA product — the Data Acquisition Unit (see [Developed Products](developed-products.md)) — including building physical test hardware.

### Scrum Master — Oct 2014 – Nov 2015
Built and supported an agile working environment for one team (10 people).

### Software Development Engineer — Jul 2005 – Sep 2014
Delivered Xpedition PCB modules (see [Developed Products](developed-products.md)). From 2010, worked within the Scrum framework and actively helped introduce and grow Scrum knowledge within the team.


## R&D Centre for Electrical Engineering and Automation in Mining EMAG

### Software Development Engineer — Nov 2000 – Jul 2005
Delivered SCADA and telemetry projects (see [Developed Products](developed-products.md)).
